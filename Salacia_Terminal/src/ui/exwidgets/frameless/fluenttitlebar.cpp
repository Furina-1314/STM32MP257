    ...
    , m_window(window)
{
    ...
    m_searchLineEdit->setPlaceholderText(QString::fromLocal8Bit("搜索..."));
...
void FluentTitleBar::updateThemeButton()
{
    ...
    m_themeButton->setToolTip(m_themeDark ? QString::fromLocal8Bit("切换到浅色主题") : QString::fromLocal8Bit("切换到暗色主题"));
}
...
void FluentTitleBar::updatePinButton()
{
    ...
    m_pinButton->setToolTip(pinned ? QString::fromLocal8Bit("取消置顶") : QString::fromLocal8Bit("置顶窗口"));
    m_pinButton->update();
}
